...
public class LoginController implements Initializable {
    ...
    void loadReg() {
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("/bnb/addMember/addmember.fxml"));
    ...
    void loadAdmin() {
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("/bnb/addMember/Adminlogin/Adminlogin.fxml"));
            Stage stage = new Stage(StageStyle.DECORATED);
            bnb.util.utils.setStageIcon(stage);
            stage.setTitle("BnB Flights");
            stage.setScene(new Scene(parent));
    ...
    void loadMain() {
        try {
            Parent parent = FXMLLoader.load(getClass().getResource("/bnb/clientMain/cmain.fxml"));
            Stage stage = new Stage(StageStyle.DECORATED);
            bnb.util.utils.setStageIcon(stage);
            stage.setTitle("BnB Flights");
            stage.setScene(new Scene(parent));
